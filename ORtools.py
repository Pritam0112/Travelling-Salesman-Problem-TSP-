...
def save_solution_to_csv(sequence, places, output_file_path):
    """Saves the solution sequence and place names to a CSV file."""
...
def main(coordinates, places, output_file_path):
    ...
    if solution:
        ...
        save_solution_to_csv(sequence, places, output_file_path)


if __name__ == "__main__":
    data_file_path = 'Data/tsp_input.csv'
    output_file_path = 'Data/tsp_warm_start_sol_50.csv'
    places, coordinates = read_data(data_file_path, nrows=50)  # change number of places (nrows) according to model
